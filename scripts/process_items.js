/*
    ...
    This file was modified by Faithix on 2026-04-01.
...
/* Iterate each file in data/items directory. */
Fs.readdirSync('../data/items').forEach(file => {
    /* Check if file is item meta file. */
    if (file.endsWith('.json')) {

        /* Read item meta. */
        var item = JSON.parse(Fs.readFileSync('../data/items/' + file));
