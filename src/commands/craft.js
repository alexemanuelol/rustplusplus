...
module.exports = {
	...
	async execute(client, interaction) {
		...
		if (craftDetails === null) {
			const str = client.intlGet(interaction.guildId, 'couldNotFindCraftDetails', {
				name: itemName
			});
			await client.interactionEditReply(interaction, DiscordEmbeds.getActionInfoEmbed(1, str));
			rustplus.log(client.intlGet(interaction.guildId, 'warningCap'), str);
		...
		client.log(client.intlGet(null, 'infoCap'), client.intlGet(interaction.guildId, 'commandsCraftDesc'));
	},
};
