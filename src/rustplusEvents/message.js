...
async function messageBroadcastTeamChanged(rustplus, client, message) {
	...
	const changed = rustplus.team.isLeaderSteamIdChanged(
		message.broadcast.teamChanged.teamInfo
	);
...
async function messageBroadcastTeamMessage(rustplus, client, message) {
	...
	const startsWithTrademark =
		message.broadcast.teamMessage.message.message.startsWith(
