...
export const COLOR_TRAVELING_VENDOR_HALTED: string = '#98C4D8';
export const COLOR_TRAVELING_VENDOR_LOCATED_AT: string = '#F4A3E2';
export const COLOR_TRAVELING_VENDOR_LEFT_MAP: string = '#5A3E9A';
export const COLOR_TRAVELING_VENDOR_MOVING: string = '#7FCE41';
